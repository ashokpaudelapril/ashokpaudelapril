...
|------|-------------|-------|
| 🌌 Summer Scholar | University of Maryland, GRAD-MAP | AI/ML for Tidal Disruption Event detection using Rubin Observatory data |
| 🧬 PREM Quantum Researcher | Texas State University, Physics | DNA nanostructures for qubit formation, 2D quantum dot arrays |
| 📡 Wi-Fi HaLow Research | Texas State, Ingram School of Engineering | Edge-managed IoT testbed: CAC, DCS, RAW protocols for high-density sensor environments |
| 🌍 Outreach Director | Trinket For Education (Nonprofit) | Raising Nepal's high school graduation rate to 90% |
| ➕ Math Tutor | Texas State, SLAC | 100+ hours of individualized tutoring across math, physics, and CS |
...
- 🌌 **UMD GRAD-MAP Summer Scholar** — Using ML to detect rare Tidal Disruption Events in Rubin Observatory time-domain data
- 🛰️ **Satellite Ground Station Lead** — Pleiades-Maia Mission: designed and deployed a 4-antenna array with automated orbit tracking
- 🔬 **UT Austin ECE Next Researcher** — Built predictive models for Metal-Assisted Chemical Etching (MacEtch) in semiconductor patterning
- 📈 **Civil Engineering ML Research** — LSTM & XGBoost models with 85%+ accuracy forecasting sensor resistance 200+ time steps ahead
- 📡 **Wi-Fi HaLow Testbed** — 90%+ device association rate and ~50% stability improvement over traditional 2.4/5 GHz Wi-Fi
...
Quantum Information  <->  DNA Nanotechnology  <->  Semiconductor Fabrication
        |                                                  |
   Machine Learning  <->  Astrophysics (TDEs)  <->  Behavioral Economics & Leadership
```
